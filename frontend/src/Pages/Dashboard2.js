...
const Dashboard2 = () => {
  ...
  return (
    ...
    bg-cover min-h-screen flex items-center justify-center flex-col'>
        <nav>
          <button className=' flex absolute top-5 right-5 bg-white text-black p-1 rounded-md' onClick={()=>navigate('/login')}>Logout</button>
        </nav>
     <h1 className='text-3xl text-white'>WELCOME TO STUDENT DASHBOARD</h1>
    </div>
  )
}
